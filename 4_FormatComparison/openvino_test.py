...
# Model Loading
person_model = YOLO("models/yolov11n_openvino_model")
volleyball_model = YOLO("models/yolov11n_vb_openvino_model")
...
while cap.isOpened():
    ...
    person_results = person_model.predict(frame, classes=0, verbose=False, device="intel:cpu")
    volleyball_results = volleyball_model.predict(frame, verbose=False, device="intel:cpu")
    ...
    cv2.imshow("OpenVINO Test", frame)
